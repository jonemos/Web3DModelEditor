...
const MenuBar = ({ onMenuAction, historyState = {} }) => {
                  ...
                  item.type === 'separator' ? (
                    ...
                    <div 
                      ...
                      className={`dropdown-item ${
                        (item.action === 'undo' && !historyState.canUndo) ||
                        (item.action === 'redo' && !historyState.canRedo)
                          ? 'disabled' : ''
                      }`}
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    >
                      <span className="item-label">
                        {item.label}
                        {item.action === 'undo' && historyState.undoDescription && 
                          ` (${historyState.undoDescription})`
                        }
                        {item.action === 'redo' && historyState.redoDescription && 
