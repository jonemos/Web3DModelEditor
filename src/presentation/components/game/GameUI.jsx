...
function GameUI() {
  ...
  useEffect(() => {
    ...
    const unsubscribeGameResumed = eventBus.subscribe('GAME_RESUMED', updateState)
  ...
  // Get camera state
  const cameraState = gameService.getCameraState()
    ...
    <>
      ...
      {isPaused && (
        <div className="pause-overlay">
          <h2>게임 일시정지</h2>
          <button onClick={() => gameService.resume()} className="resume-btn">
            계속하기
          </button>
          <button onClick={() => gameService.restart()} className="restart-btn">
            재시작
          </button>
        </div>
      )}
        ...
        <div className="sidebar-content">
          ...
          <div className="section">
            ...
            <button 
              ...
              onClick={() => gameService.toggleCameraFollowMode()}
            >
